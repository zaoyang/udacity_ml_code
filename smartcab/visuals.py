...
def plot_trials(csv):
	...
	trial_length = len(training_data)-1
	print "Trial length: ", trial_length+1
	...
	print "Ending avg reward: ", step['average_reward'][trial_length]
	...
	print "Ending total bad actions: ", (1 - actions['good'][trial_length])
	print "Ending Minor Violation",actions['minor'][trial_length]
	print "Ending Major Violation",actions['major'][trial_length]
	print "Ending Minor Accident",actions['minor_acc'][trial_length]
	print "Ending Major Accident",actions['major_acc'][trial_length]
	...
	print "Ending Success rate: ", rate[trial_length]
	...
	if len(testing_data) > 0:
		...
		print "Reliability rating: ", reliability_rating
